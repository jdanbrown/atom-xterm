...
class TermView {
  constructor(opts = {}) {
    this.uid = opts.uid || this.generateUid();
  ...
  getURI() {
    // TODO Include more/all of state? (= this.serialize())
  ...
  serialize() {
    return {
      ...
      shellOverride: this.opts.shellOverride,
      shellArguments: this.opts.shellArguments,
    };
  }
